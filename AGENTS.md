...
- For complex operations generate python or bash scripts and place it to \_\_scripts folder
- Each script in \_\_scripts folder should have comment with purpose description.
